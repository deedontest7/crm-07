...
import { Palette, Type, Image, Save, RefreshCw, Upload } from 'lucide-react';
          ...
          <CardContent>
            ...
            <div className="mt-6 p-4 border rounded-lg">
              ...
              <div className="flex items-center gap-4">
                ...
                <div 
                  className="h-12 w-24 rounded border flex items-center justify-center text-sm font-medium"
